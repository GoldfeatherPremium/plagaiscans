...
serve(async (req) => {
  ...
  try {
    ...
    // Get credits expiring in 7 days or 1 day
    const now = new Date();
    ...
    // Get credits expiring in 7 days (between 6 and 7 days from now)
    ...
    // Get credits expiring in 1 day (between now and tomorrow)
