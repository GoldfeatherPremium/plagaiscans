  ...
  const adminGroups: NavGroup[] = [
    ...
    },
    {
      ...
      links: [
        ...
        { to: '/dashboard/resellers', icon: Shield, label: 'Resellers (API)' },
      ],
    },
    {
      ...
      links: [
        ...
        { to: '/dashboard/manual-payments', icon: Wallet, label: 'Manual Payments', badgeKey: 'pendingManualPayments' },
        { to: '/dashboard/crypto-payments', icon: CreditCard, label: 'Crypto Payments', badgeKey: 'pendingCrypto' },
        ...
        { to: '/dashboard/refund-requests', icon: RotateCcw, label: 'Refund Requests' },
        { to: '/dashboard/stripe-disputes', icon: AlertTriangle, label: 'Stripe Disputes' },
        { to: '/dashboard/stripe-refunds', icon: RotateCcw, label: 'Stripe Refunds' },
    ...
    },
    {
      ...
      links: [
        { to: '/dashboard/support-tickets', icon: MessageSquare, label: 'Support Tickets', badgeKey: 'openTickets' },
    ...
    },
    {
      ...
      links: [
        ...
        { to: '/dashboard/site-content', icon: Globe, label: 'Site Content' },
