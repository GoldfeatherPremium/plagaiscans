  ...
  const adminGroups: NavGroup[] = [
    {
      ...
      links: [
        ...
        { to: '/dashboard/similarity-bulk-upload', icon: FileStack, label: 'Similarity Bulk Upload' },
        { to: '/dashboard/unmatched-reports', icon: FileQuestion, label: 'Unmatched Reports' },
        { to: '/dashboard/similarity-unmatched', icon: FileQuestion, label: 'Similarity Unmatched' },
