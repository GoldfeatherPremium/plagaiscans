...
export default function AdminBulkReportUpload() {
  ...
  const uploadAndProcess = async () => {
    ...
    try {
      ...
      // Call edge function for auto-mapping with PDF analysis
      ...
      if (data.mappedCount > 0) {
        toast.success(`Mapped ${data.mappedCount} reports with extracted percentages`);
      }
        ...
        {processingResult && (
          <Card>
            ...
            <CardContent>
              ...
              {/* Mapped Reports with extracted percentages */}
