      ...
      <div className="space-y-6">
        <div className="mb-6">
          ...
          <p className="text-muted-foreground">
            Reports are matched after upload by reading each PDF's cover page (no pre-upload preview).
          </p>
        </div>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Drag and drop PDF files or ZIP archives. Each PDF's cover page is scanned to detect the original document name and match it to a queue item.
            </CardDescription>
          </CardHeader>
          <CardContent>
            <div
                        ...
                        <div className="flex items-center gap-3 flex-1 min-w-0">
                          ...
                          <div className="min-w-0 flex-1">
                            ...
                            <p className="text-xs text-muted-foreground">
                              Match key will be extracted from PDF cover page
                            </p>
                          </div>
                        </div>
        ...
        {processingResult && (
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Cover-page name extraction + auto-mapping summary
              </CardDescription>
            </CardHeader>
            <CardContent>
